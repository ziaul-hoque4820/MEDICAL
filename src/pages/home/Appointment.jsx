...
function Appointment() {
    return (
        <section className="">
            <div
                className="w-full lg:h-[500px] sm:h-[480px] p-9"
                style={{
                ...
                <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-12">
                    {/* Text Section */}
                    <div className="w-full lg:w-1/2 text-center lg:text-left lg:mt-12 hidden md:block lg:block md:hidden">
                    ...
                    <div className="w-full lg:w-1/2 bg-blue-900 p-6 rounded-lg shadow-lg lg:mt-0 lg:self-start">
                        <form onSubmit={(e) => e.preventDefault()} className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-white">
                            <input className="p-2 bg-blue-800 rounded placeholder-white" placeholder="Name" />
                            <select
                                id="gender"
                            ...
                            <input
                                ...
                                placeholder="Email"
                            />
                            <input className="p-2 bg-blue-800 rounded placeholder-white" placeholder="Phone" />
                            <input type="date" className="p-2 bg-blue-800 rounded" />
                            <input type="time" className="p-2 bg-blue-800 rounded" />
                            <select
                                id="doctor"
                                className="bg-blue-800 border border-blue-500 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
